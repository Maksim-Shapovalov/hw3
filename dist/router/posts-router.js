...
exports.postsRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const posts = yield posts_repositories_1.postsRepositories.allPost();
...
exports.postsRouter.post('/', admin_middleware_1.authGuardMiddleware, (0, post_input_validation_middleware_1.ValidationPosts)(), error_middleware_1.ErrorMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const newPosts = yield posts_repositories_1.postsRepositories.createNewPost(req.body.title, req.body.shortDescription, req.body.content, req.body.blogId);
    res.status(201).send(newPosts);
}));
exports.postsRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const post = yield posts_repositories_1.postsRepositories.findPostById(req.params.id);
    if (post) {
...
exports.postsRouter.delete('/:id', admin_middleware_1.authGuardMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const deleted = yield posts_repositories_1.postsRepositories.delPostById(req.params.id);
    if (!deleted) {
        res.sendStatus(index_1.HTTP_STATUS.NOT_FOUND_404);
        return;
    }
